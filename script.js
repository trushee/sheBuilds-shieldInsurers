const connectButton1 = document.getElementById("connectButton");
...
const startLoading = () => {
  connectButton1.classList.add("loadingButton");
};

const stopLoading = () => {
  const timeout = setTimeout(() => {
    connectButton1.classList.remove("loadingButton");
  ...
  if (typeof window.ethereum !== "undefined") {
    ...
    ethereum
      ...
      .then((accounts) => {
        ...
        walletID.innerHTML = `<span>${account}</span>`;
